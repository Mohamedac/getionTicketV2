...
namespace gestionticket_v2.Migrations
{
    ...
    [Migration("20230529144746_Initial1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gestionticket_v2.Models.Client", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("gestionticket_v2.Models.MembreSupportTechnique", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("gestionticket_v2.Models.PieceJointe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gestionticket_v2.Models.Priorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gestionticket_v2.Models.Statistiques", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gestionticket_v2.Models.PieceJointe", b =>
                {
                    b.HasOne("gestionticket_v2.Models.Ticket", "Ticket")
            ...
            modelBuilder.Entity("gestionticket_v2.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("gestionticket_v2.Models.Categorie", "Categorie")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("gestionticket_v2.Models.ApplicationUser", null)
                        .WithMany()
